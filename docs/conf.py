...
sys.path.insert(0, os.path.abspath('./../app/lib/substrate'))
sys.path.insert(0, os.path.abspath('./../app/lib/usr'))
sys.path.insert(0, os.path.abspath('./../app/local/substrate/lib'))
sys.path.insert(0, os.path.abspath('./../app/local/usr/lib'))
...
htmlhelp_basename = 'Substratedoc'
...
latex_documents = [
  ('index', 'Substrate.tex', u'Substrate Documentation',
...
man_pages = [
    ('index', 'substrate', u'Substrate Documentation',
...
epub_title = u'Substrate'
epub_author = u'Thomas Bohmbach, Jr.'
epub_publisher = u'Thomas Bohmbach, Jr.'
epub_copyright = u'2011, Thomas Bohmbach, Jr.'
